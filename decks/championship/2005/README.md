# 2005 MTG World Championship

## Event Details

| Field | Value |
|-------|-------|
| Event | Magic: The Gathering World Championship 2005 |
| Dates | November 30 – December 4, 2005 |
| Location | Pacifico Yokohama, Yokohama, Japan |
| Format | Standard (Ravnica block + Kamigawa block) |

## Source URLs

- MTGTop8 event: https://mtgtop8.com/event?e=9254&f=ST
- Mori deck (MTG Wiki Fandom): https://mtg.fandom.com/wiki/2005_World_Championships
- Mori deck on TappedOut: https://tappedout.net/mtg-decks/katsuhiro-moris-ghazi-glare/
- Karsten deck (search result): https://moxfield.com/decks/4JLH1knm7U65O_j2QbH56g
- Frank Karsten Hall of Fame: https://www.magic.gg/news/frank-karsten-hall-of-fame
- 2005 World Championships Fandom: https://mtg.fandom.com/wiki/2005_World_Championships
- Note: No official "World Championship Decks" product was released for 2005 (Wizards confirmed this at the time).

## Top 4 Standings

| Placement | Player | Country | Deck | File |
|-----------|--------|---------|------|------|
| 1st | Katsuhiro Mori | Japan | Selesnya Ghazi-Glare (GW aggro-combo) | `01_mori_ghazi_glare.dck` |
| 2nd | Frank Karsten | Netherlands | Greater Gifts (BW/G ramp-reanimator) | `02_karsten_greater_gift.dck` |
| 3rd–4th (tie) | Akira Asahara | Japan | Enduring Ideal (W/U enchantment combo) | `03_asahara_enduring_ideal.dck` |
| 3rd–4th (tie) | Tomohiro Kaji | Japan | Selesnya Ghazi-Glare (same archetype as Mori) | `04_kaji_ghazi_glare.dck` |

## Notes on Accuracy

- **Mori (1st)**: Complete list confirmed from TappedOut and multiple secondary sources citing the exact 60-card list. High confidence.
- **Karsten (2nd)**: Complete list confirmed from multiple sources cross-referencing the "Greater Good/Gifts" build. The deck is also known as "Greater Gifts" or "BGW Gifts." High confidence.
