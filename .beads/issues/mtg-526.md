...
updated_at: 2026-05-29T14:34:48.554632743+00:00
---
...
Mox Ruby is a Power-9 zero-cost artifact mana source (sibling of the already
WORKING Mox Jet, mtg-405). Script: ManaCost:0 / Types:Artifact /
A:AB$ Mana | Cost$ T | Produced$ R. NO engine change needed —
verification-to-WORKING.

- [WORKING] Parses as zero-cost Artifact with one {T} mana ability producing {R}.
- [WORKING] Mana is spendable: taps to pay for Lightning Bolt ({R}).
- [WORKING] Marked tapped after activation; untaps in the untap step.

Expected log evidence:
  Tap Mox Ruby for mana
  (target spell resolves, proving {R} was produced)
