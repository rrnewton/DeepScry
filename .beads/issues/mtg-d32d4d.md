...
updated_at: 2025-11-21T01:18:00.155510584+00:00
---
...
PARTIALLY FIXED - ETB triggers now create tokens
...
3. **mtg-engine/src/game/actions.rs** (lines 1280-1348)
   ...
   - Creates token cards based on token_script name
   - Stub implementation for Food and Human Citizen tokens
   - Adds tokens to battlefield and logs creation
...
Should load from `forge-java/forge-gui/res/tokenscripts/` directory to get full token definitions.

## Test Results

Created test deck with Spider-Ham and ran gameplay test:
...
- `cardsfolder/f/friendly_neighborhood.txt`
- `forge-java/forge-gui/res/tokenscripts/c_a_food_sac.txt`
- `decks/spider_ham_test.dck` (test deck created)

## Next Steps

1. ✅ Implement token definition loading from tokenscripts/ directory
