...
updated_at: 2026-05-31T16:22:03.404931880+00:00
---
...
3. [BROKEN] Exile-instead (ReplaceDyingDefined$) and CantRegenerate are not
   ...
   Filed as: mtg-ioesm (DealDamage+SubAbility double-resolve + exile-instead gap).
...
unimplemented. Blocked on mtg-ioesm.

== RESOLVED 2026-05-31_#2549(221c7867), compat-finish-robots ==
CARD STATUS: WORKING. Engine gap mtg-ioesm is CLOSED (@a94df460) — the
...
Rules-review PASS recorded in mtg-ioesm (CR 614.6/616, 120.3, 704.5g). Closing.
