...
updated_at: 2026-05-29T01:28:46.686632293+00:00
---
...
Touches the bug-report dialog in web/tui_game.html (+ native_game.html once the button is added there) + web/network.js connection-state. Related: mtg-587 (bug-report pipeline). Note: the file-from-VM Stage 0 work (mtg-587) changes how reports are filed — coordinate so the precheck reflects the actual submit path.
