...
updated_at: 2026-05-28T13:30:45.439702168+00:00
---
...
## RESOLUTION (2026-05-26, branch fix-mtg-457)
...
- `cycle_ability_network_sync_e2e.sh` (seed=315, random/random): previously 180s timeout → now runs in ~21s and *exposes a separate, previously-masked gamelog desync* (~232 differing lines). Filed as mtg-458. NOT in scope of this fix.
...
- mtg-458 (newly-filed: cycle desync regression exposed by this fix)
