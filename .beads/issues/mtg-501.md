...
updated_at: 2026-05-29T16:33:16.615857645+00:00
---
...
[BROKEN] Drain Life cannot deal its damage. Casting X=2 at an opponent logs:
  Drain Life (3) has unimplemented effect 'StoreSVar'   (x3)
  Drain Life (3) deals X damage to None
Root cause: StoreSVar ApiType unimplemented + SubAbility Defined$ Targeted not
threaded through the SP$ chain + computed-SVar life cap absent. Multi-feature
gap; left BROKEN this wave.
Filed as: Bug: Drain Life — StoreSVar effect unimplemented (mtg-bn41k).

CARD STATUS: BROKEN — StoreSVar/SubAbility target chain unimplemented (mtg-bn41k).
