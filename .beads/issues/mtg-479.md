...
updated_at: 2026-05-28T13:30:46.398586881+00:00
---
...
Even if mtg-478 is fixed and the lobby reaches Connected, the game launch will still error out because the WASM card DB never gets loaded. End-to-end lobby->game flow is broken on production.
