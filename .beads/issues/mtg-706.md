...
VALIDATION: make validate green (extend test_deploy_tree_nav.js to stage + assert the hashed image too); confirm served logo carries immutable Cache-Control. owner: cas-dev (netarch team). Refs mtg-704.
