...
updated_at: 2026-06-12T14:49:30.369982326+00:00
---
...
B2 [FIXED 2026-06-12_#3307(6245a9c96)] Tragic Arrogance (1x main 01 + sideboards): Full fix in claude/compat-2015-wave4 @6245a9c96. Two engine gaps closed: (1) ChooseCard with ChooseEach$ now produces Effect::ChooseAndRememberOneOfEach{types}, iterating over each type and remembering one permanent of each kind controlled by the loop player (AI heuristic: keep highest CMC for self, lowest for opponent). (2) ValidCards$ Permanent.nonLand+!IsRemembered now parsed correctly: TargetRestriction gets requires_not_remembered=true, execute_sacrifice_all calls matches_with_remembered() which rejects cards in remembered_cards. Result: Tragic Arrogance now correctly (a) loops over each player, (b) has the caster keep one artifact/creature/enchantment/planeswalker per player, and (c) sacrifices all other nonland permanents. Tests: 7 new unit tests all pass. validate_logs/validate_6245a9c96449518fe67d9f2d3e1aa83ffce44b7d.log (PASS).
...
B4 [FIXED 2026-06-12_#3296(7dec89169)] Palace Siege (sideboard 02): ETB GenericChoice mode-select + conditional upkeep triggers implemented in claude/compat-2015-wave3 @7dec89169. Three bugs fixed: (1) ApiType::GenericChoice added to ability_parser.rs enum; (2) etb_choose_mode/etb_mode_ai_logic/etb_mode_choices fields added to CardDefinition+CardCache, propagated in instantiate() which was missing the cache assignments; (3) LoseLife placeholder resolution added to resolve_effect_placeholder() in triggers.rs (opponent was None in TriggerContext so P1 was draining itself). Also: mode_gate check in check_phase_triggers verbose log suppresses non-matching triggers. Tests: unit test_palace_siege_parses_etb_choose_mode_and_conditional_triggers + e2e test_palace_siege_etb_mode_and_drain_trigger both pass. validate PASS: validate_logs/validate_7dec89169e2c5c9e42d5dab5cc332ee24e9baf59.log.
...
HEADLINE: 59/59 unique cards (100%) validated WORKING. B1 Hangarback Walker FIXED wave1. Elspeth/Sorin emblems FIXED wave2 @2026-06-11_#3257(47178fb5). B4 Palace Siege FIXED wave3 @2026-06-12_#3296(7dec89169). B2 Tragic Arrogance FIXED wave4 @2026-06-12_#3307(6245a9c96). B3 Mastery of the Unseen remains BROKEN (Manifest unimplemented).
