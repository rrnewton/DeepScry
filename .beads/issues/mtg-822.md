...
updated_at: 2026-06-06T08:45:58.796856886+00:00
---
...
Also fixed the PutCounter log message in the same function to use the actual counter_type.display_name() instead of hardcoding "+1/+1 counter", which fixes the spurious "+1/+1 counter" log for Ral loyalty counters (mtg-823 was a separate tracking issue but shares the fix).
