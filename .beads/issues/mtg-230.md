...
updated_at: 2026-06-01T13:50:35.355214872+00:00
---
...
- [x] Sandbenders' Storm (x2) - SP$ Charm modal spells (VERIFIED 2026-01-17: Both modes work, powerGE4 restriction implemented)
  - **BUG FOUND 2026-04-20**: Earthbend 3 mode resolved without targeting a land (mtg-371, FIXED in targeting.rs)
...
- ~~**Waterbend**: Avatar-specific mechanic~~ **IMPLEMENTED** (mtg-207 CLOSED)
...
## Related Issues
- mtg-213: Ryan Avatar Deck Compatibility
- mtg-235: Julian Avatar Deck Compatibility

---
GARDENING (2026-06-01): The priority bug (Cracked Earth Technique 'Card not in hand') is FIXED per description. The remaining open items are heuristic AI evaluation gaps (mtg-77), not engine correctness bugs. The deck likely plays correctly in terms of rules; only AI strategy quality differs. Consider closing if the deck plays end-to-end without crashes or wrong-rules outcomes.
