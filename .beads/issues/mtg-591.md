...
updated_at: 2026-05-29T01:28:46.547081146+00:00
---
...
Two independent network-determinism fixes from the fix-network-desync branch (replaces the now-gone hash issue mtg-586 referenced at dispatch).
...
rogerbrand seed=3 P2 state-hash mismatch (Demonic Tutor / library-search shadow sync) filed as mtg-589; confirmed pre-existing on baseline, NOT in make validate.

Related: mtg-380, mtg-273, mtg-589.
