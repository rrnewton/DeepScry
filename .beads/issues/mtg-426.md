...
updated_at: 2026-05-28T13:30:46.554391213+00:00
---
...
- This is distinct from the WASM lethal-blocker-choice fix in ff1817f7 (mtg-418). That fix added overrides for `choose_blocker_for_lethal_damage` / `choose_blocker_for_remaining_damage`. This bug surfaces in the prior step (initial blocker declaration) and survives that fix.
- This is NOT Seismic Sense (mtg-415) and NOT the cycle/scry desync (mtg-420).
...
Suspected to be another WASM controller method that lacks an override paralleling its native NetworkLocalController/RemoteController counterparts (same class as mtg-418). Most likely candidates:
