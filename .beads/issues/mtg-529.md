...
updated_at: 2026-05-30T22:46:01.125189238+00:00
---
...
4. [BROKEN] "At the beginning of the upkeep of enchanted creature's controller,
   ...
   exploitable). Filed as mtg-92jcg. A naive fix that untaps unconditionally
...
pay-{4}-to-untap upkeep trigger not implemented (mtg-92jcg). Card is strictly
HARDER to escape than printed (safe), so it is functional as a hard lock but
not yet rules-complete. Issue stays OPEN pending mtg-92jcg.
