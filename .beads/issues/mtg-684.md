...
updated_at: 2026-06-01T15:39:26.643692950+00:00
---
...
DEPENDS ON (do AFTER current goals): the 4-page lobby/launcher REDO (mtg-682) — the deck collections + ?testing= gate live in the new launcher.html; AND the old-school deck compat goal (mtg-pph0s) — finish making the current decks WORKING before expanding the catalog. So this is post-both-goals.
