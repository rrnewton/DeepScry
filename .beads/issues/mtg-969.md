...
updated_at: 2026-06-14T12:47:30.380975087+00:00
---
...
4. [BROKEN] The 'additional {G}' (T:Mode$ TapsForMana) is NOT available to pay casting costs - see bug issue Created issue: mtg-968. A single enchanted Forest cannot pay {G}{G}, though Forest {G} + extra {G} should.

Findings (2026-06-14_#3469(2d7639fd1)) - PARTIAL. Loads/attaches/base-tap WORK; the mana-boost trigger does not contribute usable mana during cost payment. NOT puzzle-tested (the WORKING aspect cannot be cleanly puzzle-asserted without a mana assertion, and the headline aspect is broken). Tracked by bug Created issue: mtg-968.

Decisive control-vs-test reproducer is in Created issue: mtg-968.
