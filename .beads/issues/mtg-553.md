...
updated_at: 2026-05-29T15:28:12.764824147+00:00
closed_at: 2026-05-29T15:28:12.764824106+00:00
---
...
== Status ==
CARD STATUS: WORKING — taps for {W} or {U} (intrinsic mana from Plains Island subtypes, CR 305.6).

Related: 1994 Old School playtest umbrella (filed in same commit)

Findings (2026-05-29_#2440(00e22751), compat-oldschool-wave3):

1. [x] Parses as a Land with subtypes Plains Island and NO printed A: mana line.
2. [x] Loader grants one intrinsic {T}: Add ability per basic-land subtype
   (CR 305.6) producing exactly {W} or {U}. Asserted per-colour in unit test
