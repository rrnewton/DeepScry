...
updated_at: 2026-05-28T02:03:18.260748066+00:00
---

# Description

Test all behavioral aspects of Swamp in MTG Forge-rs for the 1994 Old School playtest goal.

Card file: cardsfolder/s/swamp.txt
...
== Reproducer template ==
./target/release/mtg tui --p1-draw 'Swamp' --p1=heuristic --p2=random --seed 42 --verbosity 3 --json
