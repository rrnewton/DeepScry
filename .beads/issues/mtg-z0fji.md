...
updated_at: 2026-05-28T02:03:18.210104413+00:00
---

# Description

Test all behavioral aspects of Gloom in MTG Forge-rs for the 1994 Old School playtest goal.

Card file: cardsfolder/g/gloom.txt
...
== Reproducer template ==
./target/release/mtg tui --p1-draw 'Gloom' --p1=heuristic --p2=random --seed 42 --verbosity 3 --json
