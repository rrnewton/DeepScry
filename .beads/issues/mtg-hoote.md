...
updated_at: 2026-05-28T02:03:18.262017610+00:00
---

# Description

Test all behavioral aspects of Swords to Plowshares in MTG Forge-rs for the 1994 Old School playtest goal.

Card file: cardsfolder/s/swords_to_plowshares.txt
...
== Reproducer template ==
./target/release/mtg tui --p1-draw 'Swords to Plowshares' --p1=heuristic --p2=random --seed 42 --verbosity 3 --json
