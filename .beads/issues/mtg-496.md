...
updated_at: 2026-05-29T17:14:38.465150327+00:00
closed_at: 2026-05-29T17:14:38.465150185+00:00
---
...
1. [x] Parses as {B} Instant.
2. [WORKING] A:SP$ Mana | Produced$ B | Amount$ 3 — resolving Dark Ritual adds
   {B}{B}{B} to the controller's mana pool, enough (with one Swamp) to cast a
   {1}{B}{B} creature. CR 605.

Reproducer:

```sh
./target/release/mtg tui --start-state test_puzzles/dark_ritual_mana.pzl \
  --p1=fixed --p2=zero --p1-fixed-inputs='cast Dark Ritual;cast Hypnotic Specter;pass;pass' \
...
```
  ...
  Hypnotic Specter (4) enters the battlefield as a 2/2 creature
```

Unit test: test_card_compat_dark_ritual in mtg-engine/src/game/actions/tests/effects.rs
E2E test:  tests/dark_ritual_mana_e2e.sh

CARD STATUS: WORKING — three black mana funds a 1BB cast.
