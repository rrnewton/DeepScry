...
updated_at: 2026-06-06T00:50:04.877847101+00:00
---

# Description

NON-FATAL P3 follow-up to mtg-758 (gh issue filing now works end-to-end — verified live, rrnewton/DeepScry#13). The optional GIST upload of the bug report's log artifacts (game_logs.txt + console_logs.txt) still fails; the issue files fine and its body falls back to "logs remain stored on the server". So log ATTACHMENT to issues doesn't work yet, but reporting does.
...
(paths are now ABSOLUTE — the mtg-758 fix is working; this is a separate gist failure.)
...
Discovered + characterized by slot05 during the mtg-758 live verification, 2026-06-04.
