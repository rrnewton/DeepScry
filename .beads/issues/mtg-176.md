...
updated_at: 2026-05-28T13:30:45.437336600+00:00
---
...
- [x] mtg-177: Protocol types and message serialization (CLOSED)
- [x] mtg-178: Network state hashing (HashMode::Network) (CLOSED)
- [x] mtg-179: Engine refactoring (LibraryMode::Remote) (CLOSED)
- [x] mtg-180: NetworkController implementation (CLOSED)
- [x] mtg-181: WebSocket server (CLOSED)
- [x] mtg-182: Client with shadow state (CLOSED)
- [ ] mtg-183: E2E testing
- [x] mtg-184: Action-count timestamped synchronization (protocol refactoring) (CLOSED)

## Active Bugs

- [x] mtg-263: WASM network DESYNC: CardRevealed for drawn card not processed before ability computation (CLOSED)
- [ ] mtg-264: WASM network hang: available_count mismatch after intermediate server actions
- [ ] mtg-265: WASM network: card images not loading in network mode
- [ ] mtg-266: WASM network: click focus between panes not working
- [ ] mtg-267: WASM network: clicking card doesn't show detail
- [ ] mtg-268: WASM network: interface unresponsive, flashes during opponent turn
- [ ] mtg-269: WASM network: game log only shows turn markers, not action messages
- [ ] mtg-270: WASM network: reduce console spam, put debug logs behind network-debug flag
