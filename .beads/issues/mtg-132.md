...
updated_at: 2025-11-04T11:50:22.470917068+00:00
...
What's needed:
- Set `selected_card_id` when user clicks a card (requires mtg-129 mouse support)
...
- Fully functional with: mtg-129 (mouse support)
