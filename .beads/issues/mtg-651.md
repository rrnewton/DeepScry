...
updated_at: 2026-06-11T22:17:43.043087464+00:00
---
...
== Second motivating card (2015 Worlds survey, 2026-06-10_#3175(c6dbd34f), slot07) ==
Tragic Arrogance (cardsfolder/t/tragic_arrogance.txt) — Seth Manfield 2015 World Champion board-wipe. Entire effect is A:SP$ RepeatEach (RepeatPlayers$ Player -> per-player ChooseCard one Artifact & Creature & Enchantment & Planeswalker, then SacrificeAll Permanent.nonLand+!IsRemembered). Confirmed dead: 33x "Unimplemented effect 'RepeatEach' resolved as no-op" in a 200-game mirror. See backlog mtg-922 B2 + TRACK mtg-921.
