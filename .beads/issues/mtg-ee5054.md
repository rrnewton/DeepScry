---
title: Replay verifier missing from game.html (gui_view_model)
status: open
priority: 3
issue_type: task
...
1. Decide: does game.html actually exercise rewind/replay? If yes, port the verifier wiring from fancy_tui.rs to gui_view_model.rs (extract common bits — replay_verifier.rs is already backend-neutral).
