...
updated_at: 2026-05-28T02:03:18.188821206+00:00
---

# Description

Test all behavioral aspects of Circle of Protection: Red in MTG Forge-rs for the 1994 Old School playtest goal.

Card file: cardsfolder/c/circle_of_protection_red.txt
...
== Reproducer template ==
./target/release/mtg tui --p1-draw 'Circle of Protection: Red' --p1=heuristic --p2=random --seed 42 --verbosity 3 --json
