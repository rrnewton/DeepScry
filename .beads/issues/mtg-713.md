...
updated_at: 2026-06-03T21:10:25.159705194+00:00
---
...
[DONE] B12 Kismet — global ETB-tapped replacement (R:Event$ Moved | ValidCard$
       *.OppCtrl | ReplaceWith$ ETBTapped). Structured classify in loader +
       ...
       Root Maze, …). mtg-5xn5n; gated-qualifier follow-up mtg-na64v. ON BRANCH
...
[DONE/PARTIAL] B1 GainControl — Aladdin WORKING (activated GainControl arm in
       ...
       mtg-egzyt. Old Man of the Sea: targeting fixed; exact tapped+power
       duration is a follow-up (mtg-moftl). ON BRANCH compat-1994-sweep.
