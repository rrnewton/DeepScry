...
updated_at: 2026-06-10T18:55:36.977370655+00:00
---
...
PARTIAL: Vesuvan Doppelganger (ETB copy ok; upkeep re-copy needs AddTriggers$),
  ...
  Howling Mine [FIXED — WORKING, mtg-qkjbe]: each-player extra draw routes to the active player (TriggeredPlayer), and the if-untapped intervening-if (CR 603.4) is enforced (tapped → no draw).
...
B11. [DONE — mtg-qkjbe] Howling Mine. (a) Defined$ TriggeredPlayer DrawCards now
