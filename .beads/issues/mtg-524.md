...
updated_at: 2026-05-29T14:34:48.563001586+00:00
---
...
Mox Emerald is a Power-9 zero-cost artifact mana source (sibling of the already
WORKING Mox Jet, mtg-405). Script: ManaCost:0 / Types:Artifact /
A:AB$ Mana | Cost$ T | Produced$ G. NO engine change needed —
verification-to-WORKING.

- [WORKING] Parses as zero-cost Artifact with one {T} mana ability producing {G}.
- [WORKING] Mana is spendable: taps to pay for Giant Growth ({G}).
- [WORKING] Marked tapped after activation; untaps in the untap step.

Expected log evidence:
  Tap Mox Emerald for mana
  (target spell resolves, proving {G} was produced)
