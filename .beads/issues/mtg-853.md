...
updated_at: 2026-06-06T08:45:58.795478722+00:00
---
...
3. [BROKEN] Type restriction not enforced: Observed 'Annul (49) counters Ral, Crackling Wit (81)' — Ral is a Planeswalker spell on the stack, NOT an artifact or enchantment. The ValidTgts$ Artifact,Enchantment restriction is not passed to the counter targeting engine.
   Root cause: Effect::CounterSpell only stores required_color from ValidTgts, ignoring type list. See mtg-856.
...
mtg-856 fixed — Annul's 'Artifact,Enchantment' ValidTgts restriction is enforced. Annul correctly only counters artifacts and enchantments.
