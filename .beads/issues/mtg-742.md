...
updated_at: 2026-06-06T00:50:04.850208336+00:00
---
...
RELATED: mtg-739 (scalable P2P + the same minimalist-stateless-server philosophy); asset_hash.rs CAS (content-addressing reuse); the web image CDN-table work (same hashed-static-asset + zero-egress-CDN philosophy).
