...
updated_at: 2026-06-06T08:45:58.788625385+00:00
---
...
2. [BROKEN] Back face (Steaming Sauna) not parsed: loader stops at ALTERNATE line. Steaming Sauna face inaccessible. See mtg-875.
3. [BROKEN] ETBReplacement door choice not presented: K:ETBReplacement:Other:SiegeChoice uses DB$ GenericChoice (not DB$ ChoosePlayer). Engine doesn't handle GenericChoice pattern. No door/unlock choice on ETB. See mtg-875.
4. [BROKEN] UnlockDoor trigger (T:Mode$ UnlockDoor) not firing: UnlockDoor mode not implemented in trigger system. Damage trigger cannot fire. See mtg-875.
...
Room mechanic bug tracker: mtg-875
