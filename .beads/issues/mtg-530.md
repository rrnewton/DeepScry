...
updated_at: 2026-05-29T15:28:12.765008560+00:00
closed_at: 2026-05-29T15:28:12.765008509+00:00
---
...
== Status ==
CARD STATUS: WORKING — taps for {W} (intrinsic mana from Plains subtypes, CR 305.6).

Related: 1994 Old School playtest umbrella (filed in same commit)

Findings (2026-05-29_#2440(00e22751), compat-oldschool-wave3):

1. [x] Parses as a Land with subtypes Plains and NO printed A: mana line.
2. [x] Loader grants one intrinsic {T}: Add ability per basic-land subtype
   (CR 305.6) producing exactly {W}. Asserted per-colour in unit test
