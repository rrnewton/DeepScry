...
pub use target_restriction::{ControllerRestriction, DigFilter, TargetRef, TargetRestriction, TargetType};
...
pub enum Effect {
    ...
    ForceSacrifice {
        ...
        player: PlayerId,
        /// Filter for which permanents are valid to sacrifice (parsed from `SacValid$`
        /// at load time rather than at execution time). `TargetRestriction::any()` means
        /// any permanent may be sacrificed.
        sac_restriction: TargetRestriction,
